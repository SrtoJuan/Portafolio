<html>
	...
	<body ID="cambio">
		...
		<?php
			...
			if(isset($_POST['boton'])){
				...
				$contraseñaBuena=md5('admin');
				$exito=((boolean)"");
				if(($contraseña==$contraseñaBuena) && ($nombre=="juan")){
					...
					if (isset($_POST["nombre"]) and $_POST["nombre"]<>""){
						//echo "Ha accedido como:" .$_POST["nombre"];
		...
		<section>
			<article id="cambiar">
				<form action="login.php" method="post">
					...
					Contraseña<br>
					<input type="password" name="contraseña" placeholder="Tu contraseña"><br><br>
	...
	<?php
			...
			print "Usuario y Contrseña incorectos, vuelve a intentarlo";
	?>
	<?php
			include('login.php');
		}
